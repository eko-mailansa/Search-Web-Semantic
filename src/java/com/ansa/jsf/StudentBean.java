...
import db.operations.StudentOperation;
...
public class StudentBean {
    ...
    @PostConstruct
    public void init() {
        studentsListFromDB = StudentOperation.getStudentsListFromDB();
    }
