...
import com.ansa.jsf.StudentBean;
...
public class StudentOperation {
    ...
    public static String saveStudentDetailsInDB(StudentBean newStudentObj) {
        ...
        if (saveResult != 0) {
            navigationResult = "/Home_Student.xhtml?faces-redirect=true";
        } else {
            navigationResult = "/operation/student/createStudent.xhtml?faces-redirect=true";
        }
    ...
    public static String editStudentRecordInDB(int studentId) {
        ...
        return "/operation/student/editStudent.xhtml?faces-redirect=true";
    }
    ...
    public static String updateStudentDetailsInDB(StudentBean updateStudentObj) {
        ...
        return "/Home_Student.xhtml?faces-redirect=true";
    }
